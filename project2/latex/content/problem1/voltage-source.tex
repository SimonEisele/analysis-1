...
Spannungsteiler, sowie dem Ohmschem Gesetz:
\begin{align}
...
Eine Spannungsquelle ist gegeben durch ihre maximale Leistung $P_\mathrm{0}$ und ihren Innenwiderstand $R_\mathrm{i}$.
Aus \autoref{eq:part01-max-power} lässt sich folgende Beziehung aufstellen:
\begin{equation}
    U_\mathrm{0} = 2\sqrt{P_\mathrm{0}R_\mathrm{i}}
\end{equation}
...
entsprechende Graph ist in \autoref{fig:part01-voltage-source-power-resistor} dargestellt.
\begin{figure}[H]
    \centering
...
$R_\mathrm{L} = \frac{1}{2} R_\mathrm{i}$ entspricht genau der Leistung bei $R_\mathrm{L} = 2 R_\mathrm{i}$. Prozentual
...
Wenn wir jetzt $\frac{U}{U_\mathrm{0}} = u$ und erneut $\frac{R_\mathrm{L}}{R_\mathrm{i}} = r$ setzen, erhalten wir:
\begin{equation}
    u(r) = \frac{r}{1 + r}
\end{equation}
...
\autoref{fig:part01-voltage-source-voltage-resistor} dargestellt.
\begin{figure}[H]
    \centering
