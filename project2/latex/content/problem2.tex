...
\end{equation}
Eine Funktion $f$ lässt sich als Summe zweier Funktionen $g$ und $h$ schreiben:
\begin{equation}
    f(x) = g(x) + h(x)
\end{equation}
wobei:
...
Die Summe der beiden Funktionen $g(x)$ und $h(x)$ ist in \autoref{fig:problem03-function-g-h} dargestellt. Rechts
